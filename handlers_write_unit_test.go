...
func TestWriteHandlerFieldValidation(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "put lifecycle missing expiration_days", handler: a.handlePutLifecycle, path: "/bucket/lifecycle/put", body: "bucket=test&rule_id=r1&rule_status=Enabled", wantStatus: http.StatusBadRequest},
		{name: "put lifecycle non-integer expiration_days", handler: a.handlePutLifecycle, path: "/bucket/lifecycle/put", body: "bucket=test&rule_id=r1&rule_status=Enabled&expiration_days=abc", wantStatus: http.StatusBadRequest},
		{name: "put lifecycle zero expiration_days", handler: a.handlePutLifecycle, path: "/bucket/lifecycle/put", body: "bucket=test&rule_id=r1&rule_status=Enabled&expiration_days=0", wantStatus: http.StatusBadRequest},
